  ...
  return (
    ...
    <div className="space-y-6">
      ...
      transition={{delay : 0.2}}>
        <h3 className="text-3xl font-semibold text-green-400 mb-3">Profile Information</h3>
      ...
      transition={{delay : 0.6}}>
        ...
        focus:outline-none focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-900">
          Logout
        </motion.button>
